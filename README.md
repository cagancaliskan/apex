...
<p align="center">
  <img src="docs/images/logo.png" alt="Race Strategy Workbench" width="200">
</p>
...
|----------|-------------|
| [**Quick Start**](docs/QUICKSTART.md) | All commands to run the application |
...
| [**User Guide**](docs/USER_GUIDE.md) | End-user features documentation |
