 ...
 * - Navigation between Live and Replay modes
 *
 * @module App
 */
...
const App: FC = () => {
    ...
    const handleStartSession = () => {
        if (wsRef.current?.readyState === WebSocket.OPEN && selectedSession) {
            ...
            if (!roundNum) {
                const sessionIndex = sessions.findIndex((s) => s.session_key === selectedSession.session_key);
                roundNum = sessionIndex >= 0 ? Math.floor(sessionIndex / 5) + 1 : 1;
            }
    ...
    const driversArray = raceState?.drivers ? Object.values(raceState.drivers) : [];
        ...
        <div className="app-container">
            ...
            <aside className="sidebar">
                ...
                <div style={{ flex: 1, overflow: 'auto' }}>
                    ...
                    <SessionSelector sessions={sessions} selectedSession={selectedSession} onSelect={handleSessionSelect} />
                </div>
            </aside>
