...
class DriverModel(Base):
    ...
    team_colour: Mapped[Optional[str]] = mapped_column(String(10))
...
class LapModel(Base):
    ...
    lap_duration: Mapped[Optional[float]] = mapped_column(Float)
    sector_1_time: Mapped[Optional[float]] = mapped_column(Float)
    sector_2_time: Mapped[Optional[float]] = mapped_column(Float)
    sector_3_time: Mapped[Optional[float]] = mapped_column(Float)
...
class PitStopModel(Base):
    ...
    driver_number: Mapped[int] = mapped_column(Integer, index=True)
    lap_number: Mapped[int] = mapped_column(Integer)
    pit_duration: Mapped[Optional[float]] = mapped_column(Float)
